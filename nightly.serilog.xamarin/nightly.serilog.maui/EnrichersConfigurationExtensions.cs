using nightly.serilog.maui.Enrichers;
using nightly.serilog.maui.Enrichers.DeviceInfo;
using nightly.serilog.maui.Enrichers.Display;
using nightly.serilog.maui.Enrichers.Version;
using Serilog;
